    ...
    <section className="px-4 py-10 bg-white text-black">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-8 space-y-4 text-sm md:text-base text-gray-800">
          <p>Service fees will be converted to your local currency on the payment page.</p>
          <p>
            <strong>*Passenger types:</strong> adult, infant, student, child, senior, and military.
            Transaction fees are usually non-refundable and subject to change without notice. Within
            24 hours of making the reservation, cancellations are subject to refundable transaction
            service fees. The transaction service charge is not refundable if the cancellation is
            made more than 24 hours after the reservation was made.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Up to $200 in service fees per passenger when purchasing first and business class
              tickets
            </li>
            <li>
              Up to $100 per passenger in service fees for open-jaw and multi-city reservations
            </li>
          ...
          <p>
            Service fees for bookings made at contact centers: Reservations made at contact centers
            may have greater service fees than reservations made online. This covers intricate
            international and multi-stop itineraries. A service fee of $15 to $250 (or up to $125
            for senior citizens) may be levied on each passenger.
          </p>

          <p className="text-sm md:text-base text-blue-700 font-bold border-t pt-4">
            IMPORTANT INFORMATION: ALL LISTED SERVICE FEES ARE SUBJECT TO CHANGE AT ANY TIME AND
            WITHOUT NOTICE. YOU WILL PAY THE END TOTAL PRICE AS QUOTED, REGARDLESS OF ANY CHANGES OR
            VARIATIONS IN THE SERVICE FEES. BEFORE MAKING A RESERVATION, PLEASE READ THE FINAL PRICE
            CAREFULLY.
          </p>
        </div>
      </div>
