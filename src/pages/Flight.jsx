  ...
  return (
    <>
      ...
      {showModal && (
        ...
        //         className="mx-auto w-28 h-28 mb-3 rounded-full border-4 border-green-400 object-cover"
        //       />
        ...
        //       <div className="flex justify-center gap-6 text-sm mb-6 border-b pb-3"></div>
        ...
        //       <p className="text-orange-400 font-semibold mt-4 mb-4">Click to Call !</p>
        //     </div>
        //   </div>
        ...
        <a href="tel:+18885016590">
          <div className="fixed inset-0 bg-gray-100 z-50 flex flex-col font-sans">
            {/* HEADER */}
            <div className="flex items-center justify-between py-2 border-b shadow-sm">
              <h1 className="text-lg font-bold text-gray-700 px-2">Airlinedealhub</h1>

              <div className="flex items-center space-x-2">
                <a
                  href="tel:+18885016590"
                  className="border border-green-500 text-green-600 px-2 py-1 rounded-md text-xs font-semibold"
                >
                  +1-888-501-6590
                </a>
            ...
            {/* TITLE BAR */}
            <div className="bg-gradient-to-t from-[#2B5796] to-[#3A80CE] text-gray-100 text-center py-2 text-base font-bold">
              Airline Reservations
            </div>

            {/* CONTENT */}
            <div className="flex-1 overflow-hidden px-4 py-3 text-center pb-20">
              {/* IMAGE */}
              <img
                src="data:image/jpeg;base64,"
                className="mx-auto w-24 h-24 mb-2 rounded-full border-4 border-green-400 object-cover"
              />

              <p className="text-gray-700 font-medium text-sm mb-4">24/7 Reservations & Support</p>
              ...
              <div className="grid grid-cols-2 gap-3 my-4">
                {['New Bookings', 'Changes', 'Cancellations', 'Customer Service'].map((item, i) => (
                  <button
                    key={i}
                    className="bg-gradient-to-t from-[#2B5796] to-[#3A80CE] text-white py-3 rounded font-semibold text-sm hover:bg-orange-300"
                  >
                    {item}
                  </button>
                ))}
              ...
              {/* FEATURES */}
              <div className="flex justify-center gap-6 text-sm mb-3 border-b pb-2"></div>

              {/* CTA BUTTON */}
              <a
                href="tel:+18885016590"
                className="flex items-center gap-3 bg-gradient-to-t from-[#2B5796] to-[#3A80CE] text-white py-3 px-4 rounded-full shadow-lg max-w-sm mx-auto"
              >
                ...
                <div className="text-left">
                  <p className="text-[11px] opacity-90 ml-6">
                    Call now Unpublished Phone-Only Offers
                  </p>

                  <p className="text-base font-bold ml-16">+1-888-501-6590</p>
                </div>
              </a>
              ...
              <p className="text-orange-400 font-semibold mt-2 text-sm">Click to Call !</p>
            </div>
          </div>

          {/* BOTTOM STRIP */}
          <div className="fixed bottom-2 left-0 right-0 z-50 px-3">
            <div className="flex items-center justify-between bg-white rounded-2xl shadow-xl border border-blue-400 px-3 py-2 max-w-xl mx-auto">
              {/* LEFT */}
              <div className="flex items-center gap-2">
                <img
                  src="data:image/jpeg;base64,"
                  className="w-12 h-12 object-fit rounded-full border-2 border-green-400"
                />
              </div>

              {/* CENTER */}
              <div className="flex-1 text-center">
                <p className="text-lg font-bold text-black tracking-wide">+1-888-501-6590</p>

                <p className="text-xs text-gray-600">Save Time and get our best deals</p>
              </div>

              {/* RIGHT */}
              <a
                href="tel:+18005688296"
                className="flex items-center justify-center w-10 h-10 bg-green-500 rounded-full shadow-md"
              >
                <PhoneCall className="w-5 h-5 text-white vibrate" />
              </a>
            </div>
          </div>
        </a>
