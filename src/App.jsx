...
import FullfillmentPolicy from './pages/FulfillmentPolicy';
import AirlineReservations from './pages/AirlineReservation';
  ...
  return (
    <Router>
      ...
      <Routes>
            ...
            <div className="flex flex-col min-h-screen">
              ...
              <main className="flex-grow">
                <Routes>
                  ...
                  <Route path="/fullfill" element={<FullfillmentPolicy />} />
                  <Route path="/air-reservation" element={<AirlineReservations />} />
        ...
        {/* ================= SEPARATE FULL-PAGE COMPONENT ================= */}
        {/* ❌ No Header / No Footer */}
        <Route path="/airlines-reservation" element={<Flight />} />
